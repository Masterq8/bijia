<template>
  <div class="login">
    ...
    <div class="reset-password-link" v-if="resetting">
      <router-link class="link-type" :to="'/index'">返回首页</router-link>
    </div>
    <div class="reset-password-link2" v-if="resetting">
      <router-link class="link-type" :to="'/resetting'">忘记密码？</router-link>
    </div> 
