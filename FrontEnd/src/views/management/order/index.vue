    ...
    <div class="app-container">
        ...
        <!-- <el-row>
            <div class="button-left" style="margin: 20px;">
                <el-col :span="1.5">
                    <el-button type="primary" @click="handleExport1">获取选中行数据</el-button>
                    <el-button type="primary" @click="handleExport">获取当前页数据</el-button>
                </el-col>
            </div>
            <div  class="button-right" style="margin: 20px;">
                <el-dropdown :hide-on-click="false">
                    ...
                    <template #dropdown>
                        <el-dropdown-menu>
                            <el-dropdown-item>
                                <el-checkbox v-model="checked1" label="产品订单名称" />
                            </el-dropdown-item>
                            <el-dropdown-item>
        ...
        <el-form :inline="true" ref="queryRef" :model="queryParams" class="demo-form-inline" >
            <el-form-item label="订单编号"  prop="orderNumber" style="width:240px;">
                <el-input v-model="queryParams.orderNumber" placeholder="请输入" clearable @input="handleQuery"/>
            </el-form-item>
            <el-form-item label="订单名称" style="width:240px;" prop="orderName" >
                <el-input v-model="queryParams.orderName" placeholder="请输入" clearable @input="handleQuery"/>
            </el-form-item>

            <el-form-item label="订单类别"  prop="category" style="width:240px;">
                <el-select
            ...
            <el-form-item label="订单状态" style="width:240px;" prop="state" >
                <el-select
            ...
            <el-form-item label="产品展示" style="width:240px;" prop="isShow" >
                <el-select
        ...
        >
            ...
            <el-table-column label="订单状态" align="center" prop="state" width="150">
                <template #default="scope">
                  <dict-tag
            ...
            <el-table-column
                ...
                width="130"
            />
            <el-table-column label="产品展示" align="center" prop="state" width="80">
                <template #default="scope">
                    <dict-tag
                            :options="is_show"
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="180">
                <template #default="scope">
                    <el-button v-if="scope.row.category == 'GTM' && scope.row.state == '1'" link type="primary" icon="view" @click="handleView(scope.row)">预览</el-button>
                    <el-button :loading="scope.row.isLoading" link type="primary" icon="Edit" @click="downloadOrder(scope.row.id)">下载</el-button>
                    ...
                    <el-button link type="primary" icon="el-icon-setting" v-if="scope.row.category == 'GTM' && scope.row.isShow == '0'" @click="handleCpSet(scope.row.id)">
                        设置产品展示
                    </el-button>
                    <el-button link type="primary" icon="el-icon-setting" v-if="scope.row.category == 'GTM' && scope.row.isShow == '1'" @click="handleCpCancel(scope.row.id)">
                        取消产品展示
                    </el-button>
                </template>
            </el-table-column>
...
const {is_show} = proxy.useDict("is_show");
...
function handleSelectionChange(selection) {
    ...
    console.log(selection.map(item => item));
...
/** 设置产品展示按钮操作 */
function handleCpSet(id) {
    setProductShow({id:id, isShow:'1'}).then(response => {
...
/** 取消产品展示按钮操作 */
function handleCpCancel(id) {
    setProductShow({id:id, isShow:'0'}).then(response => {
